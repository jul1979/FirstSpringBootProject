...
insert  into users(username, password, enabled) values ('jules','{noop}cesar',true);
 insert  into users(username, password, enabled) values ('ousmane','{noop}diallo',true);

 insert into authorities (username, authority)values ('jules','USER');
 insert into authorities (username, authority)values ('ousmane','ADMIN');
